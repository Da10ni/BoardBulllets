...
import { View, Text, SafeAreaView, ScrollView, TouchableOpacity, Dimensions,Modal, FlatList } from 'react-native';
      ...
      >
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', padding: 20 }}>
          <View style={{ backgroundColor: 'white', borderRadius: 12, padding: 20 }}>
            <Text style={{ fontSize: 16, fontWeight: 'bold', marginBottom: 10 }}>Jump to Question</Text>
            <FlatList
              data={QUIZ_DATA}
              ...
              renderItem={({ item, index }) => (
                <TouchableOpacity
                  ...
                  style={{
                    margin: 5,
                    backgroundColor: index < currentQuestionIndex ? '#4864AC' : '#E0E0E0',
                    padding: 10,
                    borderRadius: 8,
                  }}
                >
                  <Text style={{ color: index < currentQuestionIndex ? 'white' : 'black' }}>{item.id}</Text>
                </TouchableOpacity>
              )}
            />
  ...
  const renderSummaryScreen = () => {
    ...
    return (
      <View style={{ alignItems: 'center', marginTop: 40 }}>
        <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 20 }}>QUIZ SUMMARY</Text>
